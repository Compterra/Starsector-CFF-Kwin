...
public class KE_YZ_Structure extends BaseIndustry implements MarketImmigrationModifier {
    ...
    public static float STABILITY_PENALTY = 2f;
    public static String SPECIALMARKET = "KE_YZMarket";
    public static String CORPORATE_FACTION = "KE_YZCorporation";
...
//        market.getStability().unmodifyFlat(getModId());
    ...
    protected void addRightAfterDescriptionSection(TooltipMakerAPI tooltip, IndustryTooltipMode mode) {
        if (market.isPlayerOwned() || currTooltipMode == IndustryTooltipMode.ADD_INDUSTRY) {
            tooltip.addPara("Establishes a chartered Yunze Ordnance liaison office and opens the Yunting Ordnance Exchange, a weapons-first storefront with deep Yunze missile, energy, kinetic, and point-defense inventories.", 10f);
        }
    }
    ...
    protected void addAlphaCoreDescription(TooltipMakerAPI tooltip, AICoreDescriptionMode mode) {
        ...
        if (mode == AICoreDescriptionMode.INDUSTRY_TOOLTIP) {
            ...
            text.addPara(pre + "reduces upkeep cost by %s, reduces demand by %s unit, and increases stability by %s.", 0f, highlight,
        ...
        tooltip.addPara(pre + "reduces upkeep cost by %s, reduces demand by %s unit, and increases stability by %s.", opad, highlight,
                "" + (int) ALPHA_UPKEEP_REDUCTION + "%", "" + DEMAND_REDUCTION,
                str);
    ...
    protected void applyImproveModifiers() {
        if (isImproved()) {
            market.getStability().modifyFlat(getModId(2), IMPROVE_BONUS,
    ...
    public void addImproveDesc(TooltipMakerAPI info, ImprovementDescriptionMode mode) {
        ...
        if (mode == ImprovementDescriptionMode.INDUSTRY_TOOLTIP) {
            info.addPara("Increases stability by %s.", 0f, highlight, aStr);
        } else {
            info.addPara("Increases stability by %s.", 0f, highlight, aStr);
        }
