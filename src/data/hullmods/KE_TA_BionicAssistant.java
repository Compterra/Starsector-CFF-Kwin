...
public class KE_TA_BionicAssistant extends BaseHullMod {
    @Override
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        Hua Yan (184, 134, 11)*/
        tooltip.addPara("Flicker Aviation Group adapted this assistance suite from a damaged %s blueprint.\n" +
                        "Most of the original control logic is missing, leaving only partial mobility support.\n" +
                        "Pilots still tend to praise the system, especially after it saves them from admitting how late their turn was.",
                pad, Exodyne,
