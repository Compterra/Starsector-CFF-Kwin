...
public class KE_YZ_CorruptionEffect extends BaseCombatLayeredRenderingPlugin implements OnFireEffectPlugin,
        OnHitEffectPlugin,
        EveryFrameWeaponEffectPlugin {

    public KE_YZ_CorruptionEffect() {
    }
    ...
    protected List<KE_YZ_CorruptionEffect> trails;
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        if (trails == null) return;

        Iterator<KE_YZ_CorruptionEffect> iter = trails.iterator();
        while (iter.hasNext()) {
        ...
        if (weapon.getShip() != null) {
            ...
            for (KE_YZ_CorruptionEffect curr : trails) {
                if (curr.proj != null) {
        ...
        for (int i = 0; i < numIter; i++) {
            for (KE_YZ_CorruptionEffect trail : trails) {
...
//								   rampUp, dur, inverted);
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        KE_YZ_CorruptionEffect trail = createTrail(projectile, prev);
        ...
        if (trails == null) {
            trails = new ArrayList<KE_YZ_CorruptionEffect>();
        }
        trails.add(0, trail);
    }

    protected KE_YZ_CorruptionEffect createTrail(DamagingProjectileAPI projectile, DamagingProjectileAPI prev) {
        return new KE_YZ_CorruptionEffect(projectile, prev);
    }
    ...
    public static class ParticleData {
        ...
        public ParticleData(DamagingProjectileAPI proj, KE_YZ_CorruptionEffect effect) {
            this.proj = proj;
...
//			offset.y += vel.y * 1f;
    ...
    protected List<KE_YZ_CorruptionEffect.ParticleData> particles = new ArrayList<KE_YZ_CorruptionEffect.ParticleData>();

    protected DamagingProjectileAPI proj;
    protected DamagingProjectileAPI prev;
    protected float baseFacing = 0f;
    public KE_YZ_CorruptionEffect(DamagingProjectileAPI proj, DamagingProjectileAPI prev) {
        this.proj = proj;
        this.prev = prev;
        ...
        for (int i = 0; i < num; i++) {
            particles.add(new KE_YZ_CorruptionEffect.ParticleData(proj, this));
        }
        ...
        float index = 0;
        for (KE_YZ_CorruptionEffect.ParticleData p : particles) {
